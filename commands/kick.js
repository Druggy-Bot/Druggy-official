...
const prefix = require('../discord/schema/prefix.js')
    module.exports.run = async (bot, message, args) => {
         	if(!message.member.hasPermission("KICK_MEMBERS")) return message.channel.send("**"+message.author.username + "**, you can't use that.");
             if(!message.guild.me.hasPermission("KICK_MEMBERS")) return message.channel.send('Sorry ' + message.author + ' but i can not kick this user!')
...
.setAuthor(`${member.user.tag} has been kicked`)
